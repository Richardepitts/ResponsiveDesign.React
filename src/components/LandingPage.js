...
const useStyles = makeStyles(theme => ({
    ...
    specialText: {
        ...
        color: theme.palette.common.appleOrange
    },
    icon: {
        marginLeft: "2em",
        [theme.breakpoints.down("xs")]: {
                        ...
                        <Grid container justify="center" className={classes.buttonContainer}>
                            ...
                            <Grid item>
                                <Button 
                                    ...
                                    <ButtonArrow width={15} height={15} fill={theme.palette.common.appleBlue}/>
                                </Button>
                            </Grid>
                        </Grid>
                    </Grid>
            ...
            {/*-----Mobile App Block-----*/}
                <Grid container direction="row" justify={matchesSM ? "center" : "flex-end" } className={classes.serviceContainer}>
                    ...
                    style={{
                        ...
                        <Typography variant="subtitle1">
                        Integrate your web experience or create a standalone app {matchesSM ? null : <br />} with an Apple iPhone or iPad device.<span className={classes.specialText}>celebration</span>
                        </Typography>
                ...
                {/*-----The Revolution Block-----*/}
                  ...
                  <Grid item>
                    <Grid container style={{ height: "100em", marginTop: "8em" }} alignItems="center" justify="center">
                  ...
                  <Grid item>
                    ...
                    >
                    <Grid item container style={{ textAlign: matchesXS ? "center" : "inherit" }} direction={matchesSM ? "column" : "row"}>
                    {/*-----Piece 1-----*/}  
